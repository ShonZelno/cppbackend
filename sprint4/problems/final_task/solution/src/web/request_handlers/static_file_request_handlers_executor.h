...
class StaticFileRequestHandlerExecutor {
  ...
  using HandlerType = void (*)(const Request &, const std::filesystem::path &,
                               Send &&);
...
public:
  ...
  operator=(const StaticFileRequestHandlerExecutor &) = delete;
  StaticFileRequestHandlerExecutor(StaticFileRequestHandlerExecutor &&) =
      delete;
  StaticFileRequestHandlerExecutor &
  operator=(StaticFileRequestHandlerExecutor &&) = delete;
