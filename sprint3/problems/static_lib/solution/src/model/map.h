...
namespace model
{
    ...
    public:
        ...
        size_t GetNumberOfLootTypes() const;

        void SetLootGenerator(loot_gen::LootGenerator generator);
        void GenerateLoot(std::chrono::milliseconds time_delta, size_t dogs_count);
        const std::vector<LostObject>& GetLostObjects() const;
        void ClearLostObjects();
    ...
    private:
        ...
        loot_gen::LootGenerator loot_generator_{{}, 0.0};
        
        LostObject GenerateRandomLoot();
    };
